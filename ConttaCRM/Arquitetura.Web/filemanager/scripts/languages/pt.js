{
    "ALLOWED_FILE_TYPE": "Apenas os seguintes arquivos são permitidos: ", 
    ...
    "DISALLOWED_FILE_TYPE": "Os seguintes arquivos não são permitidos: ", 
    "ERROR_OPENING_FILE": "Erro abrindo arquivo.", 
    "ERROR_RENAMING_DIRECTORY": "Erro renomeando a pasta %s para %s.", 
    "ERROR_RENAMING_FILE": "Erro renomeando o arquivo %s para %s.", 
    "ERROR_REPLACING_FILE": "Por favor informe um arquivo com as seguintes extensões:", 
    "ERROR_SAVING_FILE": "Erro sanvando arquivo.", 
    ...
    "successful_replace": "Arquivo substituido com sucesso.", 
    "upload": "Enviar", 
    "yes": "Sim"
}